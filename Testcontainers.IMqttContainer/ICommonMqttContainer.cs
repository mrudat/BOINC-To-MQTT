// <copyright file="ICommonMqttContainer.cs" company="Martin Rudat">
...
public interface ICommonMqttContainer : IContainer
{
    ...
    public Uri GetMqttUri(string? userName = null);
    ...
    public Uri GetNetworkMqttUri(string? userName = null);
}
